...
const About = () => {
  ...
  const testimonials = [
    {
      quote:
        "FLIXBAY has completely changed the way I discover new movies. The curated recommendations are spot-on.",
      author: "Alex J.",
    },
    {
      quote:
        "I love the variety of movies available on FLIXBAY. There's always something new to watch!",
      author: "Maria S.",
    },
    {
      quote:
        "The user interface is so intuitive and easy to use. FLIXBAY is my go-to platform for movie nights.",
      author: "John D.",
    },
    {
      quote:
        "I've been using FLIXBAY for a few months now. Highly recommended!",
    },
  ];
  const settings = {
    dots: true,
      ...
      <div className=" flex p-20">
        ...
        <div className="w-[80%] md:w-[70%] mx-auto  p-6  rounded-xl border-gray-600 flex items-center justify-center">
          <p className="text-lg md:text-2xl text-gray-300 text-center ">
            <span className="text-[#6556CD] font-bold text-3xl">FLIXBAY</span>{" "}
